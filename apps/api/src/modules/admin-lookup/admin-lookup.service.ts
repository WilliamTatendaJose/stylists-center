...
function toBookingSummary(booking: BookingSummary): AdminBookingSummaryDto {
  return {
    ...
    provider: { id: booking.provider.id, displayName: booking.provider.displayName, phone: booking.provider.user.phone },
...
function toOrderSummary(order: OrderSummary): AdminOrderSummaryDto {
  return {
    ...
    status: order.status,
    buyer: order.buyer,
    provider: { id: order.provider.id, displayName: order.provider.displayName, phone: order.provider.user.phone },
